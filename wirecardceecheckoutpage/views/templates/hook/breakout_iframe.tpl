...
<body>
<h3>{l s='You will be redirected in a moment.' mod='wirecardceecheckoutpage'}</h3>
<p>{l s='If the redirect does not work please click' mod='wirecardceecheckoutpage'} <a href="#" onclick="iframeBreakout()" >{l s='here' mod='wirecardceecheckoutpage'}.</a></p>
